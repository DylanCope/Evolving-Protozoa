...
public class CellAdhesion implements Serializable  {
    ...
    public enum CAMJunctionType {
        ...
        public static CAMJunctionType randomJunctionType() {
            CAMJunctionType[] junctionTypes = CAMJunctionType.values();
            int idx = Simulation.RANDOM.nextInt(junctionTypes.length);
            return junctionTypes[idx];
        }
    }
    ...
    public interface CellAdhesionMolecule {
